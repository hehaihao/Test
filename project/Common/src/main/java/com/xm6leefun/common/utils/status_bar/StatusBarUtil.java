package com.xm6leefun.common.utils.status_bar;
...
public class StatusBarUtil {
    ...
    public static void setLightModeFull(Activity activity) {
    ...
    @TargetApi(Build.VERSION_CODES.M)
    public static void setLightModeNotFull(Activity activity) {
        setMIUIStatusBarDarkIcon(activity, true);
        setMeizuStatusBarDarkIcon(activity, true);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    private static void addTranslucentView(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        ...
        if (fakeTranslucentView != null) {
            ...
            fakeTranslucentView.setBackgroundResource(R.drawable.blue_gradient_bg);
        } else {
     ...
     * @param activity
     */
    public static void setStatusBg(Activity activity){
    ...
    private static View createTranslucentStatusBarView(Activity activity, int alpha) {
        ...
        LinearLayout.LayoutParams params =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight(activity));
        statusBarView.setLayoutParams(params);
        statusBarView.setBackgroundResource(R.drawable.blue_gradient_bg);
    ...
    public static int setStatusBarLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (MIUISetStatusBarLightMode(activity, true)) {
                ...
                activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);//字体颜色改为灰色
                result = ANDROID_M;
            }
        }
        return result;
    ...
    public static int setStatusBarDarkMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (MIUISetStatusBarLightMode(activity, false)) {
                ...
                activity.getWindow().getDecorView().setSystemUiVisibility(0);//字体颜色改为白色
                result = ANDROID_M;
            }
        }
        return result;
