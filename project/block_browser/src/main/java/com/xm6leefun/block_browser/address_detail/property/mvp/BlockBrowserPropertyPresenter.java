...
public class BlockBrowserPropertyPresenter extends BasePresenter<BlockBrowserPropertyContract.IView> {

    private  BlockBrowserPropertyContract.IModel iModel;

    public BlockBrowserPropertyPresenter(BlockBrowserPropertyContract.IView baseView) {
        super(baseView);
        iModel = new BlockBrowserPropertyModelImp(retrofitManager.createRs(BlockBrowserApiService.class));
    }
